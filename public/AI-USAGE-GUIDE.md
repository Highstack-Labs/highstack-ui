...
7 paletas (`default`/zinc, `indigo`, `teal`, `violet`, `rose`, `orange`, `cyan`) + modo oscuro. Se activan con **clases en el `<body>`** o con el provider.
...
- Clases de tema: `theme-indigo | theme-teal | theme-violet | theme-rose | theme-orange | theme-cyan` (sin clase = default/zinc).
