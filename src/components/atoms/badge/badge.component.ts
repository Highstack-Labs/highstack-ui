  ...
  protected readonly hostClasses = computed(() => {
    ...
    const styleMap: Record<BadgeColor, Record<BadgeVariant, string>> = {
      primary: {
        ...
        glass:
          'backdrop-blur-md bg-[var(--color-primary)]/20 border border-[var(--color-primary)]/30 text-[var(--color-primary)] shadow-sm',
      },
      secondary: {
        ...
        glass:
          'backdrop-blur-md bg-white/15 border border-white/25 text-white shadow-sm',
      },
      success: {
        ...
        glass:
          'backdrop-blur-md bg-emerald-400/25 border border-emerald-200/40 text-emerald-50 shadow-sm',
      },
      warning: {
        ...
        glass:
          'backdrop-blur-md bg-amber-400/25 border border-amber-200/40 text-amber-50 shadow-sm',
      },
      destructive: {
        ...
        glass:
          'backdrop-blur-md bg-[var(--color-destructive)]/25 border border-white/30 text-white shadow-sm',
      },
    };
